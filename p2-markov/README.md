...
This is the directions document for Project P2 Markov in CompSci 201 at Duke University, Spring 2024.
...
GPT is not, however, open-source, meaning that the underlying source code of the model is not freely available and the model is only accessible via API calls. Read this short article about open source code in artificial intelligence: Can’t Access GPT-3? Here’s GPT-J — Its Open-Source Cousin [accessible on Canvas](https://canvas.duke.edu/courses/21724/files/folder/Reading). 
